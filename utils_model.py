'''
modified from https://github.com/KatherLab/HIA/blob/main/models/model_Attmil.py
'''
...
class MILBagTransform(Transform):
    ...
    def __init__(self, valid_files: Iterable[Path], max_bag_size: int = 512) -> None:

        self.max_bag_size = max_bag_size
        self.valid = {f: self._draw(f) for f in valida_files}
...
class MILModel(nn.Module):
    ...
    def __init__(        
        ...
        self.encoder = nn.Sequential(nn.Linear(n_feats, 512), nn.ReLU())
